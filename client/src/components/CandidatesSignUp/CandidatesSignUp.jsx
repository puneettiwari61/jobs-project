	...
	handleSubmit = (e) => {
		...
		this.props
			...
			.catch((err) => {
				...
				this.props.dispatch(candidateAuthProgress({ isAuthInProgress: false, isAuthDone: false }));
			});
	};
								...
								<Grid container spacing={2}>
									...
									<Grid item xs={12} sm={6}>
										<TextField
											...
											errorMessages={['Contact is required', 'use 10 digit number']}
											name="contactNumber"
											variant="outlined"
											required
											fullWidth
...
export default connect(mapToProps)(withRouter(withStyles(styles)(CandidatesSignUp)));
