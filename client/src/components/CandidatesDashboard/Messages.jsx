...
class Messages extends Component {
	...
	handleConversation = (id, f, l) => {
		...
		Axios.get(`/api/v1/candidates/chats/${this.props.candidate.currentCandidate._id}/messages/${id}`)
			.then((res) => {
				console.log(res, 'from client candidate messages');
				this.setState({ messages: res.data.conversation.messages });
			})
	...
	handleSubmit = (e) => {
		...
		if (this.state.text) {
			Axios.post(`/api/v1/candidates/chats/${this.props.candidate.currentCandidate._id}/messages/${receiverId}`, {
