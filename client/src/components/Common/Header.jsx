				...
				<div class="container">
					<div class="row">
						<nav class={this.state.active ? 'col-sm-12' : 'col-sm-12 open'}>
							...
							<h2>
								<button class="pure-material-button-contained top_btns">Login</button>
								<button class="pure-material-button-contained top_btns">For Employer</button>
							</h2>
							<ul>
								<li>
									<div class="form__group">
										<input type="text" id="email" class="form__field" placeholder="Job Title" />
										<label for="email" class="form__label">
											Job Title
										</label>
									</div>
									<div class="form__group">
										<input type="text" id="email" class="form__field" placeholder="Location" />
										<label for="email" class="form__label">
											Location or Remote
										</label>
									</div>
									<button class="pure-material-button-contained">Find Jobs</button>
								</li>
							</ul>
						</nav>
					</div>
