...
function Profile(props) {
  ...
  // };
console.log("from employer dashboard profile",props)
  return (
    <div>
      <div className={classes.box}>
        <div className={classes.root}>
          ...
          >
            <Avatar
              alt="Remy Sharp"
              src={props.employer.currentEmployer.image}
        ...
        <Avatar alt="Travis Howard" src="/static/images/avatar/2.jpg" />
          ...
          {open ? (
            <div className={classes.h1}>
              {props.employer.currentEmployer.firstName +
                " " +
                props.employer.currentEmployer.lastName}
            </div>
          ) : (
            <div>
