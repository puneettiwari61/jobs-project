        ...
        <div class="page">
          <header>
            ...
            <main className="main">
              <div class="left_side">
                ...
                <h4>
                  Are you a skilled individual looking to kick start your
                  career?
                  <br />
                  OR
                  <br />
                ...
                <div class="social">
                  ...
                  <a
                    href="https://www.instagram.com/altcampus/"
                    target="_blank"
                  >
                    <button class="outline_btn">
                      <InstagramIcon />
                  ...
                  <a
                    href="https://www.linkedin.com/company/altcampus/"
                    target="_blank"
                  >
            ...
            <div id="services">
              <p class="show_more">
                ...
                <br />
                -Look into state-approved apprenticeship programs to gain skills
                and earn a salary.
                <br />
                -Contact a local public library about free classes. Many offer
                basic computer training and job skill classes.
                <br />
                -Review Occupational Skills and Employability Skills for more
              ...
              <section className="section">
                ...
                <div class="text_content">
                  <h2>Why choose us!</h2>
                  <p>
                    We connect you directly with Employer if your Skills Rating
                    is best among your Competitors. This is a Job Portal site or
                    app that enables you to find Jobs as per your Skills.
                  </p>
          ...
          <footer>
            <div class="footer__container">
              © Made in the ⛰️ by AltCampus students.
            </div>
          </footer>
        </div>
        <div id="splash">
