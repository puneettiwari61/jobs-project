...
class LandingPage extends Component {
	constructor() {
		super();
		this.state = { active: true, address: null, corona: null };
	}
	displayCorona = () => {
					...
					<header>
						<main className="header">
							<div class="logo">
								...
								{!this.props.isGeolocationAvailable ? (
									...
									//         .split(",")[0].length - 4
									//     )}`
									<span onClick={() => this.displayCorona()}>
										{this.state.address.request.response
									...
									//  `${this.state.address.request.response
									// .split("state")[2].substr(3).split(',')[0].substr(0,this.state.address.request.response
									//   .split("state")[2].substr(3).split(',')[0].length-1)

									// }`
									'Location'
								)}
							</div>
							{this.state.corona && this.state.corona ? (
						...
						<main className="main">
							<div class="left_side">
								...
								<button class="outline_btn" onClick={() => this.props.history.push('/jobs')}>
									Browse Jobs
								</button>
								<div class="social">
